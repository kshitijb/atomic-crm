...
alter table public.contact_companies
    add constraint contact_companies_contact_id_fkey foreign key (contact_id) references public.contacts(id) on update cascade on delete cascade;

alter table public.contact_companies
    add constraint contact_companies_company_id_fkey foreign key (company_id) references public.companies(id) on update cascade on delete cascade;
